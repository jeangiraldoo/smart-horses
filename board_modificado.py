...
def draw_score_panel(screen, font, ai_score, player_score, screen_width, board_width):
    panel_x = board_width + 10
    panel_width = screen_width - board_width - 20
    ...
    ai_text = font.render(f"Caballo Blanco (IA): {ai_score}", True, (0, 0, 128))
    player_text = font.render(f"Caballo Negro (Jugador): {player_score}", True, (128, 0, 0))

    screen.blit(ai_text, (panel_x + 20, 100))
    screen.blit(player_text, (panel_x + 20, 150))

    pygame.draw.line(
        screen, (120, 120, 120), (panel_x + 10, 200), (panel_x + panel_width - 10, 200), 2
    )
